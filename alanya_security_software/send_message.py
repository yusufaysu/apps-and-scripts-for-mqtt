...
# alanya-> client.publish("/02.01.65CF32FD.50FC/devListener", """{"com":"event","id":5,"durum":{"stat":false}}""")
client.publish("/02.01.65CF32FD.50FC/devListener", """{"com":"event","id":16,"durum":{"stat":true}}""")
